	...
	<div class="content-box">
		<div class="header">
			<div class="h3-container">
				<h3 class="title_link">
					<a href="${pageContext.request.contextPath}/">Thi thử TOEIC</a> » <a href="${pageContext.request.contextPath}/all_exam_listening">Thi
		...
		<div class="box-body">
			<div class="img"
				style="background: url(${pageContext.request.contextPath}/upload/${examlistening.image}); background-size: cover;"></div>
			<div class="info">
				<h3>Bộ đề ${examlistening.examinationid }</h3>
				<div class="meter">
					<span style="width: 0%"></span>
				</div>
				<i class="fa fa-plus-square"></i> Ngày tạo: <b>${examlistening.datecreate}</b><br>
				<i class="fa fa-plus-square"></i> Tổng số câu hỏi: <b>100</b><br>
				<c:if test="${examlistening.leveldifficult == 1 }">
					<i class="fa fa-plus-square"></i> Độ khó: <b>Easy</b><br>
				</c:if>
				<c:if test="${examlistening.leveldifficult == 2 }">
					<i class="fa fa-plus-square"></i> Độ khó: <b>Normal</b><br>
				</c:if>
				<c:if test="${examlistening.leveldifficult == 3 }">
					<i class="fa fa-plus-square"></i> Độ khó: <b>Hard</b><br>
				</c:if>
				<a class="button" id="exam-lnk" href="${pageContext.request.contextPath}/exam/${examlistening.examinationid}">Làm bài
					ngay</a>
			</div>
		</div>
		<div class="infobox">
