<div class="clearfix slider">
                    <ul class="pgwSlider">
                        <li><img src="<%=request.getContextPath() %>/templates/public/images/thumbs/megamind_07.jpg" alt="Paris, France" data-description="Eiffel Tower and Champ de Mars" data-large-src="images/slides/megamind_07.jpg" /></li>
                        <li><img src="<%=request.getContextPath() %>/templates/public/images/thumbs/wall-e.jpg" alt="Montréal, QC, Canada" data-large-src="images/slides/wall-e.jpg" data-description="Eiffel Tower and Champ de Mars" /></li>
                        <li>
                    ...
                    <div class="clearfix single_content">
                        ...
                        <div class="clearfix post_detail">
                            ...
                            <div class="clearfix post_excerpt">
                                <img src="<%=request.getContextPath() %>/templates/public/images/thumb.png" alt="" />
