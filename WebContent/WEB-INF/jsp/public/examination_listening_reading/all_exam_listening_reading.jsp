...
<div class="content">
	<div class="content-box">
		...
		<div class="box">
			<c:forEach items="${allsumary }" var="objexam">
				<div class="box-item">
					<a href="${pageContext.request.contextPath}/exam_sumary/${objexam.examinationid}">
						<div class="img"
							style="background: url(${pageContext.request.contextPath}/upload/${objexam.image}); background-size: cover;">
							<p>0/100</p>
						</div>
						<div class="meter">
		...
		<div class="paging">
			<ul class="pagination-sm pagination" id="paging-34">
				<li class="page active"><a href="${pageContext.request.contextPath}/all_exam_sumary">1</a></li>
				<li class="page"><a href="${pageContext.request.contextPath}/all_exam_sumary">2</a></li>
				<li class="last"><a href="${pageContext.request.contextPath}/all_exam_sumary">»</a></li>
			</ul>
		</div>
		<script>
