...
<div class="content">
	<div class="content-box">
		...
		<div class="box">
			<c:forEach items="${allexamreading }" var="objreading">
				<div class="box-item">
					<a href="${pageContext.request.contextPath}/exam_reading/${objreading.examinationid}">
						...
						<h4>Bộ đề ${objreading.examinationid }(${objreading.nameexamination })</h4>
					</a><a class="learn" href="${pageContext.request.contextPath}/exam_reading/${objreading.examinationid}">Luyện ngay</a>
				</div>
			</c:forEach>
		</div>
		...
		<div class="paging">
			<ul class="pagination-sm pagination" id="paging-34">
				<li class="page active"><a href="${pageContext.request.contextPath}/all_exam_reading">1</a></li>
				<li class="page"><a href="${pageContext.request.contextPath}/all_exam_reading">2</a></li>
				<li class="last"><a href="${pageContext.request.contextPath}/all_exam_reading">»</a></li>
			</ul>
		</div>
		<script>
