	...
	<div class="content-box">
		<div class="header">
			<div class="h3-container">
				<h3 class="title_link">
					<a href="${pageContext.request.contextPath}/">Thi thử TOEIC</a> » <a href="${pageContext.request.contextPath}/all_exam_reading">Thi
		...
		<div class="box-body">
			<div class="img"
				style="background: url(${pageContext.request.contextPath}/upload/${examreading.image}); background-size: cover;"></div>
			<div class="info">
				<h3>Bộ đề ${examreading.examinationid }</h3>
				<div class="meter">
					<span style="width: 0%"></span>
				</div>
				<i class="fa fa-plus-square"></i> Ngày tạo: <b>${examreading.datecreate}</b><br>
				<i class="fa fa-plus-square"></i> Tổng số câu hỏi: <b>100</b><br>
				<c:if test="${examreading.leveldifficult == 1 }">
					<i class="fa fa-plus-square"></i> Độ khó: <b>Easy</b><br>
				</c:if>
				<c:if test="${examreading.leveldifficult == 2 }">
