...
<%@include file="/templates/taglib.jsp"%>
                <div class="content-box-large">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <a href="${pageContext.request.contextPath}/admin/questionlistening/listenadd" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Add Listening</a>
                        </div>
                        
                        <div class="col-md-4">
                            <form action="${pageContext.request.contextPath}/admin/questionlistening/search" method="post">
	                                ...
	                                <c:forEach items="${listquestion }" var="objquestion">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td class="center text-center">
		                         				<a href="${pageContext.request.contextPath}/admin/questionlistening/listenedit/${objquestion.questionid }" title="" class="btn btn-primary"><span class="glyphicon glyphicon-pencil "></span> Sửa</a>
								...
								<nav class="text-center" aria-label="...">
									<ul class="pagination">
										...
										<li <c:if test="${page == i }">class="active"</c:if>><a
												href="${pageContext.request.contextPath}/admin/questionlistening/${i}">${i}<span
