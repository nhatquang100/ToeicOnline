...
<%@include file="/templates/taglib.jsp"%>
                <div class="content-box-large">
					...
					<div class="row">
                        <div class="col-md-4">
                            <form action="${pageContext.request.contextPath}/admin/examination/search" method="post">
	                            <div class="input-group form">
	                                <input type="text" class="form-control" placeholder="Search..." name = "examinationname">
